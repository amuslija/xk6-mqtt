...
This extension is tested with k6 version `v0.43.1` last release is [v0.39.2](https://github.com/amuslija/xk6-mqtt/releases/tag/v0.39.2).
...
docker run --rm -it -u "$(id -u):$(id -g)" -v "${PWD}:/xk6" grafana/xk6 build v0.43.1 --with github.com/amuslija/xk6-mqtt@v0.39.2
...
wget -O test.js https://raw.githubusercontent.com/amuslija/xk6-mqtt/main/examples/test.js
...
1. Install `xk6`:
  ...
  ```shell
  git clone github.com/amuslija/xk6-mqtt
  cd xk6-mqtt
  $ xk6 build --with github.com/amuslija/xk6-mqtt=.
  ```
